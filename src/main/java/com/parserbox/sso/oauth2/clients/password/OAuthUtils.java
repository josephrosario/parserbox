package com.parserbox.sso.oauth2.clients.password;
...
public class OAuthUtils {
	...
	public static Token getAccessToken(OAuth2Config oauthDetails) {
		...
		try {
			...
			accessToken = new Token((Long) (map.get(OAuthConstants.EXPIRES_IN)), (String) map.get(OAuthConstants.TOKEN_TYPE), (String) map.get(OAuthConstants.REFRESH_TOKEN), (String) map.get(OAuthConstants.ACCESS_TOKEN));
		} catch (ClientProtocolException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (IOException e) {
